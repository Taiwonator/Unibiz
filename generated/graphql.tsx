...
export type Query = {
  ...
  FindSimilarEvents?: Maybe<Array<Maybe<Event>>>;
...
export type QueryFindSimilarEventsArgs = {
...
export type AddEventImageUrlsMutation = {
  __typename?: 'Mutation';
  addEventImageUrls?: { __typename?: 'Event'; id?: string | null } | null;
};
...
export type DeleteEventImageUrlMutation = {
  __typename?: 'Mutation';
  deleteEventImageUrl?: string | null;
};
...
export type GetAllEventsQuery = {
  ...
  Event?: Array<{
    ...
    id?: string | null;
    name?: string | null;
    tags?: Array<EventType | null> | null;
...
export type FindUnverifiedEventsQueryVariables = Exact<{
  [key: string]: never;
}>;

export type FindUnverifiedEventsQuery = {
  __typename?: 'Query';
  FindUnverifiedEvents?: Array<{
    __typename?: 'Event';
    id?: string | null;
    name?: string | null;
    tags?: Array<EventType | null> | null;
...
export type GetEventByIdQuery = {
  ...
  FindEventById?: {
    ...
    eventImageUrls?: Array<string | null> | null;
    location?: {
      __typename?: 'Location';
      type?: string | null;
      address?: string | null;
...
export type FindEventBySocietyIdQuery = {
  __typename?: 'Query';
  FindEventBySocietyId?: Array<{
    __typename?: 'Event';
    id?: string | null;
    name?: string | null;
    tags?: Array<EventType | null> | null;
...
export type FindEventByUnionIdQuery = {
  __typename?: 'Query';
  FindEventByUnionId?: Array<{
    __typename?: 'Event';
    id?: string | null;
    name?: string | null;
    tags?: Array<EventType | null> | null;
...
export type FindSimilarEventsQueryVariables = Exact<{
  eventId: Scalars['String'];
}>;

export type FindSimilarEventsQuery = {
  __typename?: 'Query';
  FindSimilarEvents?: Array<{
    __typename?: 'Event';
    id?: string | null;
    name?: string | null;
    tags?: Array<EventType | null> | null;
...
export type ProcessUserRequestMutation = {
  __typename?: 'Mutation';
  processUserRequest?:
    | { __typename?: 'Society'; id?: string | null }
    | { __typename?: 'Union'; id?: string | null }
    | null;
};
...
export type GroupQuery = {
  ...
  FindGroupById?:
    | {
        ...
        userRequestIds?: Array<string | null> | null;
        createdAt?: string | null;
        users?: Array<{
          __typename?: 'User';
          id?: string | null;
    ...
    | {
        ...
        userIds?: Array<string | null> | null;
        userRequestIds?: Array<string | null> | null;
        societyRequestIds?: Array<string | null> | null;
        users?: Array<{
          __typename?: 'User';
          id?: string | null;
          name?: string | null;
        ...
        uni?: { __typename?: 'Uni'; name?: string | null } | null;
        societies?: Array<{
          __typename?: 'Society';
          id?: string | null;
          name?: string | null;
...
export type EditSocietyMutation = {
  __typename?: 'Mutation';
  editSociety?: {
    __typename?: 'Society';
    id?: string | null;
...
export type CreateSocietyMutation = {
  __typename?: 'Mutation';
  createSociety?: { __typename?: 'Society'; id?: string | null } | null;
};
...
export type DeleteSocietyMutation = {
  __typename?: 'Mutation';
  deleteSociety?: {
    __typename?: 'Society';
    id?: string | null;
...
export type LeaveSocietyMutation = {
  __typename?: 'Mutation';
  leaveSociety?: {
    __typename?: 'Society';
    name?: string | null;
...
export type RequestSocietyFromUserMutation = {
  __typename?: 'Mutation';
  requestSocietyFromUser?: { __typename?: 'User'; id?: string | null } | null;
};
...
export type GetAllSocietiesQuery = {
  __typename?: 'Query';
  Society?: Array<{
    __typename?: 'Society';
    id?: string | null;
...
export type GetSocietyByIdQuery = {
  __typename?: 'Query';
  FindSocietyById?: {
    __typename?: 'Society';
    id?: string | null;
...
export type RequestUnionFromUserMutation = {
  __typename?: 'Mutation';
  requestUnionFromUser?: { __typename?: 'User'; id?: string | null } | null;
};
...
export type RequestUnionFromSocietyMutation = {
  __typename?: 'Mutation';
...
export type RemoveSocietyFromUnionMutation = {
  __typename?: 'Mutation';
  removeSocietyFromUnion?: { __typename?: 'Union'; id?: string | null } | null;
};
...
export type ProcessSocietyRequestMutation = {
  __typename?: 'Mutation';
  processSocietyRequest?: { __typename?: 'Union'; id?: string | null } | null;
};

export type GetAllUnionsQueryVariables = Exact<{ [key: string]: never }>;

export type GetAllUnionsQuery = {
  __typename?: 'Query';
  Union?: Array<{
    __typename?: 'Union';
    id?: string | null;
    ...
    imageUrl?: string | null;
    userIds?: Array<string | null> | null;
    societyIds?: Array<string | null> | null;
    societyRequestIds?: Array<string | null> | null;
    uni?: { __typename?: 'Uni'; name?: string | null } | null;
    faqs?: Array<{
      __typename?: 'FAQ';
...
export type LoginCredentialsUserMutation = {
  __typename?: 'Mutation';
...
export type CreatePasswordlessUserMutation = {
  __typename?: 'Mutation';
...
export type SetUserCurrentGroupMutation = {
  __typename?: 'Mutation';
  setUserCurrentGroup?: {
    __typename?: 'State';
    id?: string | null;
...
export type UpdateUserNameMutation = {
  __typename?: 'Mutation';
  updateUserName?: { __typename?: 'User'; id?: string | null } | null;
};
...
export type GetUserByIdQuery = {
  ...
  FindUserById?: {
    __typename?: 'User';
    name?: string | null;
    state?: { __typename?: 'State'; currentGroup?: string | null } | null;
    societies?: Array<{
      __typename?: 'Society';
      id?: string | null;
      name?: string | null;
...
export type GetUserByEmailQuery = {
  __typename?: 'Query';
  FindUserByEmail?: { __typename?: 'User'; id?: string | null } | null;
};
...
export function useEditEventMutation() {
  return Urql.useMutation<EditEventMutation, EditEventMutationVariables>(
    EditEventDocument
  );
}
...
export function useLikeEventMutation() {
  return Urql.useMutation<LikeEventMutation, LikeEventMutationVariables>(
    LikeEventDocument
  );
}
...
export function useAddEventImageUrlsMutation() {
  return Urql.useMutation<
    AddEventImageUrlsMutation,
    AddEventImageUrlsMutationVariables
  >(AddEventImageUrlsDocument);
}
...
export function useDeleteEventImageUrlMutation() {
  return Urql.useMutation<
    ...
    DeleteEventImageUrlMutationVariables
  >(DeleteEventImageUrlDocument);
}
...
export function useFindUnverifiedEventsQuery(
  options?: Omit<Urql.UseQueryArgs<FindUnverifiedEventsQueryVariables>, 'query'>
) {
  return Urql.useQuery<
    FindUnverifiedEventsQuery,
    FindUnverifiedEventsQueryVariables
  >({ query: FindUnverifiedEventsDocument, ...options });
}
...
export function useGetEventByIdQuery(
  options?: Omit<Urql.UseQueryArgs<GetEventByIdQueryVariables>, 'query'>
) {
  return Urql.useQuery<GetEventByIdQuery, GetEventByIdQueryVariables>({
...
export function useFindEventBySocietyIdQuery(
  options?: Omit<Urql.UseQueryArgs<FindEventBySocietyIdQueryVariables>, 'query'>
) {
  return Urql.useQuery<
    FindEventBySocietyIdQuery,
    FindEventBySocietyIdQueryVariables
  >({ query: FindEventBySocietyIdDocument, ...options });
}
...
export function useFindEventByUnionIdQuery(
  options?: Omit<Urql.UseQueryArgs<FindEventByUnionIdQueryVariables>, 'query'>
) {
  return Urql.useQuery<
    FindEventByUnionIdQuery,
    FindEventByUnionIdQueryVariables
  >({ query: FindEventByUnionIdDocument, ...options });
}
...
export function useGetPastEventsQuery(
  options?: Omit<Urql.UseQueryArgs<GetPastEventsQueryVariables>, 'query'>
) {
  return Urql.useQuery<GetPastEventsQuery, GetPastEventsQueryVariables>({
    query: GetPastEventsDocument,
    ...options,
  });
}
export const FindSimilarEventsDocument = gql`
...
export function useFindSimilarEventsQuery(
  options: Omit<Urql.UseQueryArgs<FindSimilarEventsQueryVariables>, 'query'>
) {
  return Urql.useQuery<FindSimilarEventsQuery, FindSimilarEventsQueryVariables>(
    { query: FindSimilarEventsDocument, ...options }
  );
}
...
export function useLeaveGroupMutation() {
  return Urql.useMutation<LeaveGroupMutation, LeaveGroupMutationVariables>(
    LeaveGroupDocument
  );
}
...
export function useProcessUserRequestMutation() {
  return Urql.useMutation<
    ...
    ProcessUserRequestMutationVariables
  >(ProcessUserRequestDocument);
}
...
export function useGroupQuery(
  ...
  return Urql.useQuery<GroupQuery, GroupQueryVariables>({
    query: GroupDocument,
    ...options,
  });
}
export const EditSocietyDocument = gql`
  mutation EditSociety(
    $societyId: String!
    $name: String
    $shortName: String
    $description: String
...
export function useEditSocietyMutation() {
  return Urql.useMutation<EditSocietyMutation, EditSocietyMutationVariables>(
    EditSocietyDocument
  );
}
...
export function useDeleteSocietyMutation() {
  return Urql.useMutation<
    ...
    DeleteSocietyMutationVariables
...
export function useLeaveSocietyMutation() {
  return Urql.useMutation<LeaveSocietyMutation, LeaveSocietyMutationVariables>(
    LeaveSocietyDocument
  );
}
...
export function useRequestSocietyFromUserMutation() {
  return Urql.useMutation<
    RequestSocietyFromUserMutation,
    RequestSocietyFromUserMutationVariables
  >(RequestSocietyFromUserDocument);
}
...
export function useGetAllSocietiesQuery(
  options?: Omit<Urql.UseQueryArgs<GetAllSocietiesQueryVariables>, 'query'>
) {
  return Urql.useQuery<GetAllSocietiesQuery, GetAllSocietiesQueryVariables>({
    query: GetAllSocietiesDocument,
    ...options,
  });
}
...
export function useGetSocietyByIdQuery(
  options?: Omit<Urql.UseQueryArgs<GetSocietyByIdQueryVariables>, 'query'>
) {
  return Urql.useQuery<GetSocietyByIdQuery, GetSocietyByIdQueryVariables>({
    query: GetSocietyByIdDocument,
    ...options,
  });
}
...
export function useEditUnionMutation() {
  return Urql.useMutation<EditUnionMutation, EditUnionMutationVariables>(
    EditUnionDocument
  );
}
...
export function useEditFaqMutation() {
  return Urql.useMutation<EditFaqMutation, EditFaqMutationVariables>(
    EditFaqDocument
  );
}
...
export function useRequestUnionFromUserMutation() {
  return Urql.useMutation<
    ...
    RequestUnionFromUserMutationVariables
  >(RequestUnionFromUserDocument);
}
...
export function useRequestUnionFromSocietyMutation() {
  return Urql.useMutation<
    ...
    RequestUnionFromSocietyMutationVariables
  >(RequestUnionFromSocietyDocument);
}
...
export function useRemoveSocietyFromUnionMutation() {
  return Urql.useMutation<
    ...
    RemoveSocietyFromUnionMutationVariables
  >(RemoveSocietyFromUnionDocument);
}
export const ProcessSocietyRequestDocument = gql`
  mutation ProcessSocietyRequest(
    $societyId: String!
    $unionId: String!
    $accept: Boolean!
  ) {
    processSocietyRequest(
      societyId: $societyId
      unionId: $unionId
      accept: $accept
    ) {
...
export function useProcessSocietyRequestMutation() {
  return Urql.useMutation<
    ...
    ProcessSocietyRequestMutationVariables
  >(ProcessSocietyRequestDocument);
}
...
export function useGetAllUnionsQuery(
  options?: Omit<Urql.UseQueryArgs<GetAllUnionsQueryVariables>, 'query'>
) {
  return Urql.useQuery<GetAllUnionsQuery, GetAllUnionsQueryVariables>({
    query: GetAllUnionsDocument,
    ...options,
  });
}
...
export function useLoginCredentialsUserMutation() {
  return Urql.useMutation<
    LoginCredentialsUserMutation,
    LoginCredentialsUserMutationVariables
  >(LoginCredentialsUserDocument);
}
...
export function useCreatePasswordlessUserMutation() {
  return Urql.useMutation<
    ...
    CreatePasswordlessUserMutationVariables
  >(CreatePasswordlessUserDocument);
}
...
export function useSetUserCurrentGroupMutation() {
  return Urql.useMutation<
    SetUserCurrentGroupMutation,
    SetUserCurrentGroupMutationVariables
  >(SetUserCurrentGroupDocument);
}
