window.onload = function () {
  // begins animatino within 200 milliseconds
...
function start() {
  ...
  var canvas = document.getElementById('canvas'),
    ...
    shootingStars = [],
    layers = [
      { speed: 0.015 * 50, scale: 0.2, count: star_count },
      { speed: 0.03 * 50, scale: 0.5, count: star_count * 0.15 },
      { speed: 0.05 * 50, scale: 0.75, count: star_count * 0.1 },
    ],
    starsAngle = 145,
    shootingStarSpeed = {
      min: 15,
  ...
  function drawShootingStar(p) {
    ...
    //trail
    context.fillStyle = 'rgba(3, 253, 202, ' + p.opacity + ')';
    context.beginPath();
    context.moveTo(x - 1, y - 1);
